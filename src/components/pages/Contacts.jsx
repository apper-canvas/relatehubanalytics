...
const filtered = contacts.filter(contact => {
      ...
      return (
        ...
        ((contact.tags_c || contact.tags) && (typeof (contact.tags_c || contact.tags) === 'string' ? (contact.tags_c || contact.tags).split(',').map(tag => tag.trim()) : (contact.tags_c || contact.tags)).some(tag => 
